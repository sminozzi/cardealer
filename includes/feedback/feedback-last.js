jQuery(document).ready(function($) {
	...
	$deactivateSearch.click(function(evt) {
		...
		} else if (billstring.includes('cardealer')) {
			$deactivateLink = billstring;
			product = 'Car Dealer Plugin';
			prodclass = 'car_dealer_plugin';
		} else if (billstring.includes('reportattacks')) {
			$deactivateLink = billstring;
			product = 'reportattacks';
			prodclass = 'report_attacks';
		} else if (billstring.includes('stopbadbots')) {
			$deactivateLink = billstring;
			product = 'stopbadbots';
		...
		if (prodclass != 'car_dealer_plugin') {
			$('.car_dealer_plugin-wrap-deactivate').slideUp();
		}
		...
		$("." + prodclass + "-deactivate").click(function() {
			...
			if (!$(this).hasClass('disabled')) {
                ...
                window.location.href = billstring;
			}
		});
