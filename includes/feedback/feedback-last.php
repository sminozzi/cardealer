<?php  Namespace CarDealerPlugin_last_feedback{
    ...
    if ( __NAMESPACE__ == 'CarDealerPlugin_last_feedback')
    {
        define(__NAMESPACE__ .'\PRODCLASS', "car_dealer_plugin" );
        define(__NAMESPACE__ .'\VERSION', CARDEALERVERSION );
        define(__NAMESPACE__ .'\PLUGINHOME', "http://CarDealerPlugin.com" );
        define(__NAMESPACE__ .'\PRODUCTNAME', "Car Dealer Plugin" );
        define(__NAMESPACE__ .'\LANGUAGE', "cardealer" );
        define(__NAMESPACE__ .'\PAGE', "settings" );
        define(__NAMESPACE__ .'\OPTIN', "car_dealer_plugin_optin" );
